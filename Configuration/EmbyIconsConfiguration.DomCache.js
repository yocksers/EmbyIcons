define([], function () {
    ...
    function getDomElements(view) {
        return {
            ...
            txtAlbumSearch: view.querySelector('#txtAlbumSearch'),
            albumSearchResults: view.querySelector('#albumSearchResults'),
            btnRunMusicScan: view.querySelector('#btnRunMusicScan'),
            btnRunFullMusicScan: view.querySelector('#btnRunFullMusicScan'),
            musicReportContainer: view.querySelector('#musicReportContainer'),
            musicTroubleshooterChecks: view.querySelectorAll('#musicTroubleshooterChecksContainer input[type=checkbox]'),

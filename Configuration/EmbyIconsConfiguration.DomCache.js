define([], function () {
    ...
    function getDomElements(view) {
        return {
            ...
            txtMovieSearch: view.querySelector('#txtMovieSearch'),
            movieSearchResults: view.querySelector('#movieSearchResults'),
            btnRunMovieScan: view.querySelector('#btnRunMovieScan'),
            btnRunFullMovieScan: view.querySelector('#btnRunFullMovieScan'),
            movieReportContainer: view.querySelector('#movieReportContainer'),
            movieTroubleshooterChecks: view.querySelectorAll('#movieTroubleshooterChecksContainer input[type=checkbox]'),
